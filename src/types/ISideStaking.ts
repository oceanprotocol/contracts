...
export interface ISideStakingInterface extends utils.Interface {
  contractName: "ISideStaking";
  functions: {
    ...
    "getbBaseTokenBalance(address)": FunctionFragment;
    ...
    "notifyFinalize(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "getbBaseTokenBalance",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "notifyFinalize",
    values: [string]
  ): string;
...
export interface ISideStaking extends BaseContract {
  contractName: "ISideStaking";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISideStakingInterface;
