...
export declare namespace ERC20TemplateEnterprise {
  ...
  export type OrderParamsStruct = {
    ...
    _providerFees: ERC20TemplateEnterprise.ProviderFeesStruct;
  };

  export type OrderParamsStructOutput = [
    string,
    BigNumber,
    ERC20TemplateEnterprise.ProviderFeesStructOutput
  ] & {
    consumer: string;
    serviceIndex: BigNumber;
    _providerFees: ERC20TemplateEnterprise.ProviderFeesStructOutput;
  };

  export type FreParamsStruct = {
  ...
  export type FreParamsStructOutput = [
    string,
    string,
    BigNumber,
    BigNumber,
...
export interface ERC20TemplateEnterpriseInterface extends utils.Interface {
  ...
  functions: {
    ...
    "buyFromDispenserAndOrder((address,uint256,(address,address,uint256,uint8,bytes32,bytes32,uint256,bytes)),address)": FunctionFragment;
    "buyFromFreAndOrder((address,uint256,(address,address,uint256,uint8,bytes32,bytes32,uint256,bytes)),(address,bytes32,uint256,uint256,address))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "buyFromDispenserAndOrder",
    values: [ERC20TemplateEnterprise.OrderParamsStruct, string]
  ): string;
  encodeFunctionData(
    functionFragment: "buyFromFreAndOrder",
    values: [
      ERC20TemplateEnterprise.OrderParamsStruct,
      ERC20TemplateEnterprise.FreParamsStruct
    ]
  ): string;
  ...
  encodeFunctionData(
    ...
    values: [BytesLike, ERC20TemplateEnterprise.ProviderFeesStruct]
  ): string;
  ...
  encodeFunctionData(
    ...
    values: [string, BigNumberish, ERC20TemplateEnterprise.ProviderFeesStruct]
  ): string;
  ...
  events: {
    ...
    "BuyAndOrder(address,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "BuyAndOrder"): EventFragment;
...
export type BuyAndOrderEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  { buyer: string; baseTokenAmount: BigNumber; marketFeeAmount: BigNumber }
>;

export type BuyAndOrderEventFilter = TypedEventFilter<BuyAndOrderEvent>;
...
export interface ERC20TemplateEnterprise extends BaseContract {
  contractName: "ERC20TemplateEnterprise";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20TemplateEnterpriseInterface;
  ...
  functions: {
    ...
    buyFromDispenserAndOrder(
      _orderParams: ERC20TemplateEnterprise.OrderParamsStruct,
      dispenserContract: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    buyFromFreAndOrder(
      _orderParams: ERC20TemplateEnterprise.OrderParamsStruct,
      _freParams: ERC20TemplateEnterprise.FreParamsStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    getFixedRates(
      overrides?: CallOverrides
    ): Promise<[ERC20TemplateEnterprise.FixedRateStructOutput[]]>;
  ...
  filters: {
    ...
    "BuyAndOrder(address,uint256,uint256)"(
      buyer?: null,
      baseTokenAmount?: null,
      marketFeeAmount?: null
    ): BuyAndOrderEventFilter;
    BuyAndOrder(
      buyer?: null,
      baseTokenAmount?: null,
      marketFeeAmount?: null
