...
import type { BMath, BMathInterface } from "../BMath";
...
type BMathConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: BMathConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class BMath__factory extends ContractFactory {
  constructor(...args: BMathConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
      super(_abi, _bytecode, args[0]);
    }
    this.contractName = "BMath";
  }
  ...
  static readonly contractName: "BMath";
  public readonly contractName: "BMath";
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): BMathInterface {
    return new utils.Interface(_abi) as BMathInterface;
  }
