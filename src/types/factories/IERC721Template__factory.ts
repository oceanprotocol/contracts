...
import type {
  IERC721Template,
  IERC721TemplateInterface,
} from "../IERC721Template";
    ...
    outputs: [
      {
        ...
        internalType: "struct IERC721Template.Roles",
        name: "",
        type: "tuple",
      },
    ],
...
export class IERC721Template__factory {
  static readonly abi = _abi;
  static createInterface(): IERC721TemplateInterface {
    return new utils.Interface(_abi) as IERC721TemplateInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IERC721Template {
    return new Contract(address, _abi, signerOrProvider) as IERC721Template;
  }
}
