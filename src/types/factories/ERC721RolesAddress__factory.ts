...
import type {
  ERC721RolesAddress,
  ERC721RolesAddressInterface,
} from "../ERC721RolesAddress";
...
type ERC721RolesAddressConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ERC721RolesAddressConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ERC721RolesAddress__factory extends ContractFactory {
  constructor(...args: ERC721RolesAddressConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
      super(_abi, _bytecode, args[0]);
    }
    this.contractName = "ERC721RolesAddress";
  }

  deploy(
    overrides?: Overrides & { from?: string | Promise<string> }
  ): Promise<ERC721RolesAddress> {
    return super.deploy(overrides || {}) as Promise<ERC721RolesAddress>;
  }
  ...
  attach(address: string): ERC721RolesAddress {
    return super.attach(address) as ERC721RolesAddress;
  }
  connect(signer: Signer): ERC721RolesAddress__factory {
    return super.connect(signer) as ERC721RolesAddress__factory;
  }
  static readonly contractName: "ERC721RolesAddress";
  public readonly contractName: "ERC721RolesAddress";
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ERC721RolesAddressInterface {
    return new utils.Interface(_abi) as ERC721RolesAddressInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ERC721RolesAddress {
    return new Contract(address, _abi, signerOrProvider) as ERC721RolesAddress;
  }
}
