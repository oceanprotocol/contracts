...
export class IFactoryRouter__factory {
  static readonly abi = _abi;
  static createInterface(): IFactoryRouterInterface {
    return new utils.Interface(_abi) as IFactoryRouterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IFactoryRouter {
    return new Contract(address, _abi, signerOrProvider) as IFactoryRouter;
  }
}
