...
async function testDeployment() {
  ...
  keys = ["startBlock", "Router", "FixedPrice", "FixedPriceEnterprise","ERC20Template", "ERC721Template", "Dispenser", "ERC721Factory","AccessListFactory","Escrow","COMPY","COMPYSwap","COMPYFaucet"]
